...
def navigationBar(navRoot, text, x, y, command):
...
def mainWindows(mainRoot):
    ...
    showLogo = windows.CTkButton(
        ...
        bg_color="black",
        hover_color="black",
        command=lambda: mainWindows(mainRoot)
    )
    showLogo.place(x=100, y=45)
    navigationBar(mainRoot, "Home", 550, 75, lambda: mainWindows(mainRoot))
    navigationBar(mainRoot, "Process", 650, 75, lambda: learnMore(mainRoot))
    navigationBar(mainRoot, "About", 750, 75, lambda: aboutUs(mainRoot))
    navigationBar(mainRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(mainRoot))
...
def secondWindows(secondRoot):
    for widget in secondRoot.winfo_children():
        widget.destroy()

    secondRoot.configure(fg_color="black")
    ...
    showLogo = windows.CTkButton(
        ...
        bg_color="black",
        hover_color="black",
        command=lambda: mainWindows(secondRoot)
    )
    showLogo.place(x=100, y=45)

    navigationBar(secondRoot, "Home", 550, 75, lambda: mainWindows(secondRoot))
    navigationBar(secondRoot, "Process", 650, 75, lambda: learnMore(secondRoot))
    navigationBar(secondRoot, "About", 750, 75, lambda: aboutUs(secondRoot))
    navigationBar(secondRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(secondRoot))
...
def processCLook(processRoot, noOfTracksEntry, pastTrackEntry, presentTrackEntry,
    ...
    showPlot(processRoot, plotCLookResults, noOfTracks, alphaX, sentence)
...
def showPlot(showPlotRoot, plotCLookResults, noOfTracks, alphaX, sentence):
    for widget in showPlotRoot.winfo_children():
        widget.destroy()

    showPlotRoot.configure(fg_color="black")
    ...
    showLogo = windows.CTkButton(
        ...
        bg_color="black",
        hover_color="black",
        command=lambda: mainWindows(showPlotRoot)
    )
    showLogo.place(x=100, y=45)

    navigationBar(showPlotRoot, "Home", 550, 75, lambda: mainWindows(showPlotRoot))
    navigationBar(showPlotRoot, "Process", 650, 75, lambda: learnMore(showPlotRoot))
    navigationBar(showPlotRoot, "About", 750, 75, lambda: aboutUs(showPlotRoot))
    navigationBar(showPlotRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(showPlotRoot))
    ...
    backButton = windows.CTkButton(
        ...
        fg_color="#FF520E",
        hover_color="#D9430C",
        command=lambda: secondWindows(showPlotRoot)
    )
    backButton.place(x=640, y=550)


def learnMore(learnMoreRoot):
    for widget in learnMoreRoot.winfo_children():
        widget.destroy()

    learnMoreRoot.configure(fg_color="black")
    ...
    navigationBar(learnMoreRoot, "Home", 550, 75, lambda: mainWindows(learnMoreRoot))
    navigationBar(learnMoreRoot, "Process", 650, 75, lambda: learnMore(learnMoreRoot))
    navigationBar(learnMoreRoot, "About", 750, 75, lambda: aboutUs(learnMoreRoot))
    navigationBar(learnMoreRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(learnMoreRoot))
...
def aboutUs(aboutUsRoot):
    for widget in aboutUsRoot.winfo_children():
        widget.destroy()

    aboutUsRoot.configure(fg_color="black")
    ...
    showLogo = windows.CTkButton(
        ...
        bg_color="black",
        hover_color="black",
        command=lambda: mainWindows(aboutUsRoot)
    )
    showLogo.place(x=100, y=45)

    navigationBar(aboutUsRoot, "Home", 550, 75, lambda: mainWindows(aboutUsRoot))
    navigationBar(aboutUsRoot, "Process", 650, 75, lambda: learnMore(aboutUsRoot))
    navigationBar(aboutUsRoot, "About", 750, 75, lambda: aboutUs(aboutUsRoot))
    navigationBar(aboutUsRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(aboutUsRoot))
...
def frequentlyAskedQuestions(FAQRoot):
    for widget in FAQRoot.winfo_children():
        widget.destroy()

    FAQRoot.configure(fg_color="black")
    ...
    showLogo = windows.CTkButton(
        ...
        bg_color="black",
        hover_color="black",
        command=lambda: mainWindows(FAQRoot)
    )
    showLogo.place(x=100, y=45)

    navigationBar(FAQRoot, "Home", 550, 75, lambda: mainWindows(FAQRoot))
    navigationBar(FAQRoot, "Process", 650, 75, lambda: learnMore(FAQRoot))
    navigationBar(FAQRoot, "About", 750, 75, lambda: aboutUs(FAQRoot))
    navigationBar(FAQRoot, "FAQs", 850, 75, lambda: frequentlyAskedQuestions(FAQRoot))
